...
const functionsConsumerAbi = require("./baseAbi.json");
...
const makeRequestMumbai = async () => {
  ...
  const source = fs
    .readFileSync(path.resolve(__dirname, "sourceBase.js"))
    .toString();
  ...
  const rpcUrl = 'https://avalanche-fuji.drpc.org/'; // fetch mumbai RPC URL
